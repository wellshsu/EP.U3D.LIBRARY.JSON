...
namespace EP.U3D.LIBRARY.JSON
{
    ...
    public class JsonMapper
    {
        ...
        protected static int max_nesting_depth;

        protected static IFormatProvider datetime_format;

        protected static IDictionary<Type, ExporterFunc> base_exporters_table;
        protected static IDictionary<Type, ExporterFunc> custom_exporters_table;

        protected static IDictionary<Type,
            IDictionary<Type, ImporterFunc>> base_importers_table;

        protected static IDictionary<Type,
            IDictionary<Type, ImporterFunc>> custom_importers_table;

        protected static IDictionary<Type, ArrayMetadata> array_metadata;
        protected static readonly object array_metadata_lock = new Object();

        protected static IDictionary<Type,
            IDictionary<Type, MethodInfo>> conv_ops;

        protected static readonly object conv_ops_lock = new Object();

        protected static IDictionary<Type, ObjectMetadata> object_metadata;
        protected static readonly object object_metadata_lock = new Object();

        protected static IDictionary<Type,
            IList<PropertyMetadata>> type_properties;

        protected static readonly object type_properties_lock = new Object();

        protected static JsonWriter static_writer;
        protected static readonly object static_writer_lock = new Object();
        ...
        protected static void AddTypeProperties(Type type)
        {
        ...
        protected static MethodInfo GetConvOp(Type t1, Type t2)
        {
            lock (conv_ops_lock)
            {
        ...
        protected static object ReadValue(Type inst_type, JsonReader reader)
        {
            reader.Read();
        ...
        protected static IJsonWrapper ReadValue(WrapperFactory factory,
            JsonReader reader)
        {
            reader.Read();
        ...
        protected static void ReadSkip(JsonReader reader)
        {
            ToWrapper(
